package com.unionpay.smartDG.overlay;
...
import com.unionpay.smartDG.util.Constants;
import com.unionpay.smartDG.util.ToastUtil;
...
public class CustomMarkerActivity extends Activity implements OnMarkerClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.custommarker_activity);
		/*
	 ...
	 */
	private void init() {
		markerText = (TextView) findViewById(com.unionpay.smartDG.R.id.mark_listenter_text);
		radioOption = (RadioGroup) findViewById(com.unionpay.smartDG.R.id.custom_info_window_options);
		Button clearMap = (Button) findViewById(com.unionpay.smartDG.R.id.clearMap);
		clearMap.setOnClickListener(this);
		Button resetMap = (Button) findViewById(com.unionpay.smartDG.R.id.resetMap);
	...
	private void addMarkersToMap() {
		...
		// .fromResource(R.drawable.location_marker)
				BitmapDescriptorFactory.fromBitmap(BitmapFactory
						.decodeResource(getResources(),
								com.unionpay.smartDG.R.drawable.location_marker)));
		...
		marker3 = aMap.addMarker(new MarkerOptions().position(
				...
				BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.ic_launcher)));
	}
	...
	public View getInfoContents(Marker marker) {
		if (radioOption.getCheckedRadioButtonId() != com.unionpay.smartDG.R.id.custom_info_contents) {
			return null;
		}
		View infoContent = getLayoutInflater().inflate(
				com.unionpay.smartDG.R.layout.custom_info_contents, null);
	...
	public View getInfoWindow(Marker marker) {
		if (radioOption.getCheckedRadioButtonId() != com.unionpay.smartDG.R.id.custom_info_window) {
			return null;
		}
		View infoWindow = getLayoutInflater().inflate(
				com.unionpay.smartDG.R.layout.custom_info_window, null);
	...
	public void render(Marker marker, View view) {
		if (radioOption.getCheckedRadioButtonId() == com.unionpay.smartDG.R.id.custom_info_contents) {
			((ImageView) view.findViewById(com.unionpay.smartDG.R.id.badge))
					.setImageResource(com.unionpay.smartDG.R.drawable.badge_sa);
		} else if (radioOption.getCheckedRadioButtonId() == com.unionpay.smartDG.R.id.custom_info_window) {
			ImageView imageView = (ImageView) view.findViewById(com.unionpay.smartDG.R.id.badge);
			imageView.setImageResource(com.unionpay.smartDG.R.drawable.badge_wa);
		}
		String title = marker.getTitle();
		TextView titleUi = ((TextView) view.findViewById(com.unionpay.smartDG.R.id.title));
		if (title != null) {
		...
		TextView snippetUi = ((TextView) view.findViewById(com.unionpay.smartDG.R.id.snippet));
		if (snippet != null) {
	...
	public void onClick(View v) {
		 ...
		 * 清空地图上所有已经标注的marker
		 */
		case com.unionpay.smartDG.R.id.clearMap:
			if (aMap != null) {
				aMap.clear();
			}
			break;
		 ...
		 * 重新标注所有的marker
		 */
		case com.unionpay.smartDG.R.id.resetMap:
			if (aMap != null) {
				aMap.clear();
				addMarkersToMap();
			}
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		if(checkedId == com.unionpay.smartDG.R.id.default_info_window) {
			//取消自定义InfoWindow，则使用默认InfoWindow样式
			aMap.setInfoWindowAdapter(null);
		} else if (checkedId == com.unionpay.smartDG.R.id.custom_info_contents) {
			aMap.setInfoWindowAdapter(this);
		} else if (checkedId == com.unionpay.smartDG.R.id.custom_info_window) {
			aMap.setInfoWindowAdapter(this);
		}
	}
}
