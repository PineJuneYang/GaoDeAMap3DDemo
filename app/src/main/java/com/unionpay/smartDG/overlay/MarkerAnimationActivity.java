...
public class MarkerAnimationActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.marker_animation_activity);
		/*
	 ...
	 */
	private void init() {
		Button clearMap = (Button) findViewById(com.unionpay.smartDG.R.id.growMarker);
		clearMap.setOnClickListener(this);
		Button resetMap = (Button) findViewById(com.unionpay.smartDG.R.id.jumpMarker);
	...
	private void addMarkerInScreenCenter() {
		...
		screenMarker = aMap.addMarker(new MarkerOptions()
				.anchor(0.5f,0.5f)
				.icon(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.purple_pin)));
	...
	public void onClick(View v) {
		 ...
		 * 从地上生长的Marker
		 */
		case com.unionpay.smartDG.R.id.growMarker:
			startGrowAnimation();
			break;
		/**
		 * marker 跳动动画
		 */
		case com.unionpay.smartDG.R.id.jumpMarker:
			startJumpAnimation();
			break;
		default:
			break;
