...
public class PolylineActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.polyline_activity);
        /*
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
	 ...
	 */
	private void init() {
		mColorBar = (SeekBar) findViewById(com.unionpay.smartDG.R.id.hueSeekBar);
		mColorBar.setMax(HUE_MAX);
		mColorBar.setProgress(50);

		mAlphaBar = (SeekBar) findViewById(com.unionpay.smartDG.R.id.alphaSeekBar);
		mAlphaBar.setMax(ALPHA_MAX);
		mAlphaBar.setProgress(255);

		mWidthBar = (SeekBar) findViewById(com.unionpay.smartDG.R.id.widthSeekBar);
	...
	private void addPolylinesWithTexture() {
		...
		texTuresList.add(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.map_alr));
		texTuresList.add(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.custtexture));
		texTuresList.add(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.map_alr_night));
