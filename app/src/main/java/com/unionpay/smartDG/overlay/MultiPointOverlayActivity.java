...
public class MultiPointOverlayActivity extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		BitmapDescriptor bitmapDescriptor = BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.marker_blue);
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					inputStream = MultiPointOverlayActivity.this.getResources().openRawResource(com.unionpay.smartDG.R.raw.point10w);
