package com.unionpay.smartDG.geocoder;
...
public class GeocoderActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.geocoder_activity);
        /*
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
	...
	private void init() {
		...
		Button geoButton = (Button) findViewById(com.unionpay.smartDG.R.id.geoButton);
	...
	public void onGeocodeSearched(GeocodeResult result, int rCode) {
		...
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getGeocodeAddressList() != null
				...
				ToastUtil.show(GeocoderActivity.this, com.unionpay.smartDG.R.string.no_result);
			}
		} else {
	...
	public void onClick(View v) {
		 ...
		 * 响应地理编码按钮
		 */
		case com.unionpay.smartDG.R.id.geoButton:
