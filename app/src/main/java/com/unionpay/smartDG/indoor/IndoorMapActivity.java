package com.unionpay.smartDG.indoor;
...
public class IndoorMapActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.indoormap_activity);
	    /*
...
//        list.add("F5");
        ...
        floorSwitchView = (IndoorFloorSwitchView) findViewById(com.unionpay.smartDG.R.id.indoor_switchview);
