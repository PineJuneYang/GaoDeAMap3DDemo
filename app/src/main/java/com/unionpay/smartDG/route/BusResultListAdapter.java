...
public class BusResultListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, com.unionpay.smartDG.R.layout.item_bus_result, null);
			holder.title = (TextView) convertView.findViewById(com.unionpay.smartDG.R.id.bus_path_title);
			holder.des = (TextView) convertView.findViewById(com.unionpay.smartDG.R.id.bus_path_des);
