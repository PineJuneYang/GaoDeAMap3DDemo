...
public class DriveSegmentListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, com.unionpay.smartDG.R.layout.item_bus_segment,
					null);
		...
		if (position == 0) {
			holder.driveDirIcon.setImageResource(com.unionpay.smartDG.R.drawable.dir_start);
			...
			holder.driveDirIcon.setImageResource(com.unionpay.smartDG.R.drawable.dir_end);
