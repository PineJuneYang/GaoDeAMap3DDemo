...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.unionpay.smartDG.R.layout.route_activity);
		
		mContext = this.getApplicationContext();
		mapView = (MapView) findViewById(com.unionpay.smartDG.R.id.route_map);
...
//		getIntentData();
	...
	private void setfromandtoMarker() {
		...
		.icon(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.start)));
		aMap.addMarker(new MarkerOptions()
		.position(AMapUtil.convertToLatLng(mEndPoint))
		.icon(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.end)));
	}
	...
	private void init() {
		...
		mBottomLayout = (RelativeLayout) findViewById(com.unionpay.smartDG.R.id.bottom_layout);
		mBusResultLayout = (LinearLayout) findViewById(com.unionpay.smartDG.R.id.bus_result);
		mRotueTimeDes = (TextView) findViewById(com.unionpay.smartDG.R.id.firstline);
		mRouteDetailDes = (TextView) findViewById(com.unionpay.smartDG.R.id.secondline);
		mDrive = (ImageView)findViewById(com.unionpay.smartDG.R.id.route_drive);
		mBus = (ImageView)findViewById(com.unionpay.smartDG.R.id.route_bus);
		mWalk = (ImageView)findViewById(com.unionpay.smartDG.R.id.route_walk);
		mBusResultList = (ListView) findViewById(com.unionpay.smartDG.R.id.bus_result_list);
	}
	...
	public void onBusClick(View view) {
		...
		mDrive.setImageResource(com.unionpay.smartDG.R.drawable.route_drive_normal);
		mBus.setImageResource(com.unionpay.smartDG.R.drawable.route_bus_select);
		mWalk.setImageResource(com.unionpay.smartDG.R.drawable.route_walk_normal);
	...
	public void onDriveClick(View view) {
		...
		mDrive.setImageResource(com.unionpay.smartDG.R.drawable.route_drive_select);
		mBus.setImageResource(com.unionpay.smartDG.R.drawable.route_bus_normal);
		mWalk.setImageResource(com.unionpay.smartDG.R.drawable.route_walk_normal);
	...
	public void onWalkClick(View view) {
		...
		mDrive.setImageResource(com.unionpay.smartDG.R.drawable.route_drive_normal);
		mBus.setImageResource(com.unionpay.smartDG.R.drawable.route_bus_normal);
		mWalk.setImageResource(com.unionpay.smartDG.R.drawable.route_walk_select);
		mapView.setVisibility(View.VISIBLE);
		mBusResultLayout.setVisibility(View.GONE);
	}
		...
		if (errorCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getPaths() != null) {
				if (result.getPaths().size() > 0) {
					...
					ToastUtil.show(mContext, com.unionpay.smartDG.R.string.no_result);
				}
			} else {
				ToastUtil.show(mContext, com.unionpay.smartDG.R.string.no_result);
			}
