...
public class LayersActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.layers_activity);
	    /*
	...
	private void init() {
		...
		CheckBox traffic = (CheckBox) findViewById(com.unionpay.smartDG.R.id.traffic);
		traffic.setOnClickListener(this);
		
		CheckBox buildings = (CheckBox) findViewById(com.unionpay.smartDG.R.id.building);
		buildings.setOnClickListener(this);
		
		CheckBox maptext = (CheckBox) findViewById(com.unionpay.smartDG.R.id.maptext);
	...
	public void onClick(View v) {
		if (v.getId() == com.unionpay.smartDG.R.id.traffic) {
			aMap.setTrafficEnabled(((CheckBox) v).isChecked());// 显示实时交通状况
		} else if (v.getId() == com.unionpay.smartDG.R.id.building) {
			aMap.showBuildings(((CheckBox) v).isChecked());// 显示3D 楼块
		} else if (v.getId() == com.unionpay.smartDG.R.id.maptext) {
