...
public class EventsActivity extends Activity implements OnMapClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.events_activity);
		/*
	...
	private void init() {
		...
		mTapTextView = (TextView) findViewById(com.unionpay.smartDG.R.id.tap_text);
		mCameraTextView = (TextView) findViewById(com.unionpay.smartDG.R.id.camera_text);
		mTouchTextView = (TextView) findViewById(com.unionpay.smartDG.R.id.touch_text);
	}
