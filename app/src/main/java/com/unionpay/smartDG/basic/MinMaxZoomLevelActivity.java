...
public class MinMaxZoomLevelActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.unionpay.smartDG.R.layout.min_max_zoomlevel_activity);

        mapView = (MapView) findViewById(com.unionpay.smartDG.R.id.map);
        mapView.onCreate(savedInstanceState);
        init();

        textMinZoomLevel = (EditText) findViewById(com.unionpay.smartDG.R.id.text_min);
        textMaxZoomLevel = (EditText) findViewById(com.unionpay.smartDG.R.id.text_max);
        textCurrentLevel = (TextView) findViewById(com.unionpay.smartDG.R.id.text_current_level);
