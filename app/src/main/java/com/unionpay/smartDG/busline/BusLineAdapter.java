...
public class BusLineAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = layoutInflater.inflate(com.unionpay.smartDG.R.layout.busline_item, null);
			holder = new ViewHolder();
			holder.busName = (TextView) convertView.findViewById(com.unionpay.smartDG.R.id.busname);
			holder.busId = (TextView) convertView.findViewById(com.unionpay.smartDG.R.id.busid);
