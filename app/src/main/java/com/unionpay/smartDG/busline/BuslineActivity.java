package com.unionpay.smartDG.busline;
...
public class BuslineActivity extends Activity implements OnMarkerClickListener,
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.unionpay.smartDG.R.layout.busline_activity);
        /*
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
	...
	private void init() {
		...
		Button searchByName = (Button) findViewById(com.unionpay.smartDG.R.id.searchbyname);
		searchByName.setOnClickListener(this);
		selectCity = (Spinner) findViewById(com.unionpay.smartDG.R.id.cityName);
		...
		searchName = (EditText) findViewById(com.unionpay.smartDG.R.id.busName);
	}
	...
	class BusLineDialog extends Dialog implements OnClickListener {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(com.unionpay.smartDG.R.layout.busline_dialog);
			preButton = (Button) findViewById(com.unionpay.smartDG.R.id.preButton);
			nextButton = (Button) findViewById(com.unionpay.smartDG.R.id.nextButton);
			listView = (ListView) findViewById(com.unionpay.smartDG.R.id.listview);
	...
	public void onBusLineSearched(BusLineResult result, int rCode) {
		...
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getQuery() != null
				...
				ToastUtil.show(BuslineActivity.this, com.unionpay.smartDG.R.string.no_result);
			}
		} else {
