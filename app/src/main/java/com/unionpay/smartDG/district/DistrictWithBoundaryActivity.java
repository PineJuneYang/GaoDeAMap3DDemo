...
public class DistrictWithBoundaryActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.district_boundary_activity);
		mButton = (Button) findViewById(com.unionpay.smartDG.R.id.search_button);
		mEditText = (EditText) findViewById(com.unionpay.smartDG.R.id.city_text);
