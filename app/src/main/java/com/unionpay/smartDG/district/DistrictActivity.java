package com.unionpay.smartDG.district;
...
public class DistrictActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.district_activity);

		tv_countryInfo = (TextView) findViewById(com.unionpay.smartDG.R.id.tv_countryInfo);
		tv_provinceInfo = (TextView) findViewById(com.unionpay.smartDG.R.id.tv_provinceInfo);
		tv_cityInfo = (TextView) findViewById(com.unionpay.smartDG.R.id.tv_cityInfo);
		tv_districtInfo = (TextView) findViewById(com.unionpay.smartDG.R.id.tv_districtInfo);

		spinnerProvince = (Spinner) findViewById(com.unionpay.smartDG.R.id.spinner_province);
		spinnerCity = (Spinner) findViewById(com.unionpay.smartDG.R.id.spinner_city);
		spinnerDistrict = (Spinner) findViewById(com.unionpay.smartDG.R.id.spinner_district);
