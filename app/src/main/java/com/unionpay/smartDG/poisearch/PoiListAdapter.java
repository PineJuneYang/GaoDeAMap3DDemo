...
public class PoiListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(ctx, com.unionpay.smartDG.R.layout.listview_item, null);
            holder.poititle = (TextView) convertView
                   .findViewById(com.unionpay.smartDG.R.id.poititle);
            holder.subpois = (GridView) convertView.findViewById(com.unionpay.smartDG.R.id.listview_item_gridview);
