package com.unionpay.smartDG.routepoi;
...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener, OnRoutePOISearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.unionpay.smartDG.R.layout.routepoi_activity);
	...
	private void init() {
		...
		gasbtn = (TextView)findViewById(com.unionpay.smartDG.R.id.gasbtn);
		ATMbtn= (TextView)findViewById(com.unionpay.smartDG.R.id.ATMbtn);
		Maibtn= (TextView)findViewById(com.unionpay.smartDG.R.id.Maibtn);
		Toibtn= (TextView)findViewById(com.unionpay.smartDG.R.id.Toibtn);
	}
		...
		if (errorCode == AMapException.CODE_AMAP_SUCCESS) {
			if(result != null){
				...
				if (items != null && items.size() > 0) {
					...
					ToastUtil.show(RoutePOIActivity.this, com.unionpay.smartDG.R.string.no_result);
				}
			}
		}else{
