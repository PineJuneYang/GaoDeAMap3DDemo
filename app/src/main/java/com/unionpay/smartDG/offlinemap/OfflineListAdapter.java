	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = (RelativeLayout) RelativeLayout.inflate(
					mContext, com.unionpay.smartDG.R.layout.offlinemap_group, null);
		}
		group_text = (TextView) convertView.findViewById(com.unionpay.smartDG.R.id.group_text);
		group_image = (ImageView) convertView
				.findViewById(com.unionpay.smartDG.R.id.group_image);
		...
		if (isOpen[groupPosition]) {
			group_image.setImageDrawable(mContext.getResources().getDrawable(
					com.unionpay.smartDG.R.drawable.downarrow));
		} else {
			group_image.setImageDrawable(mContext.getResources().getDrawable(
					com.unionpay.smartDG.R.drawable.rightarrow));
		}
		return convertView;
	}
