package com.unionpay.smartDG.offlinemap;
...
//						Toast.LENGTH_SHORT).show()
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.offline_map_layout);
	...
	private void init() {
		...
		// 顶部
		mDownloadText = (TextView) findViewById(com.unionpay.smartDG.R.id.download_list_text);
		mDownloadedText = (TextView) findViewById(com.unionpay.smartDG.R.id.downloaded_list_text);

		mDownloadText.setOnClickListener(this);
		mDownloadedText.setOnClickListener(this);
		mBackImage = (ImageView) findViewById(com.unionpay.smartDG.R.id.back_image_view);
		mBackImage.setOnClickListener(this);

		// view pager 用到了所有城市list和已下载城市list所有放在最后初始化
		mContentViewPage = (ViewPager) findViewById(com.unionpay.smartDG.R.id.content_viewpage);
	...
	public void initAllCityList() {
		...
		View provinceContainer = LayoutInflater.from(OfflineMapActivity.this)
				.inflate(com.unionpay.smartDG.R.layout.offline_province_listview, null);
		mAllOfflineMapList = (ExpandableListView) provinceContainer
				.findViewById(com.unionpay.smartDG.R.id.province_download_list);
	...
	public void initDownloadedList() {
		mDownLoadedList = (ListView) LayoutInflater.from(
				...
				com.unionpay.smartDG.R.layout.offline_downloaded_list, null);
	...
	public void onClick(View v) {
		if (v.equals(mDownloadText)) {
			...
			mDownloadText
					.setBackgroundResource(com.unionpay.smartDG.R.drawable.offlinearrow_tab1_pressed);

			mDownloadedText
					.setBackgroundResource(com.unionpay.smartDG.R.drawable.offlinearrow_tab2_normal);
			...
			mDownloadText
					.setBackgroundResource(com.unionpay.smartDG.R.drawable.offlinearrow_tab1_normal);
			mDownloadedText
					.setBackgroundResource(com.unionpay.smartDG.R.drawable.offlinearrow_tab2_pressed);
			mDownloadedText.setPadding(paddingHorizontal, paddingVertical,
					paddingHorizontal, paddingVertical);
			mDownloadText.setPadding(paddingHorizontal, paddingVertical,
					paddingHorizontal, paddingVertical);
