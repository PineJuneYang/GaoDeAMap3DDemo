...
public class OfflineChild implements OnClickListener, OnLongClickListener {
	...
	private void initView() {
		...
		mOffLineChildView = inflater.inflate(com.unionpay.smartDG.R.layout.offlinemap_child, null);
		mOffLineCityName = (TextView) mOffLineChildView.findViewById(com.unionpay.smartDG.R.id.name);
		mOffLineCitySize = (TextView) mOffLineChildView
				.findViewById(com.unionpay.smartDG.R.id.name_size);
		mDownloadImage = (ImageView) mOffLineChildView
				.findViewById(com.unionpay.smartDG.R.id.download_status_image);
		mDownloadProgress = (TextView) mOffLineChildView
				.findViewById(com.unionpay.smartDG.R.id.download_progress_status);
	...
	private void displayDefault() {
		...
		mDownloadImage.setImageResource(com.unionpay.smartDG.R.drawable.offlinearrow_download);
	}
	...
	private void displayWaitingStatus(int completeCode) {
		mDownloadProgress.setVisibility(View.VISIBLE);
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(com.unionpay.smartDG.R.drawable.offlinearrow_start);
	...
	private void displaySuccessStatus() {
		...
		mDownloadProgress.setTextColor(mContext.getResources().getColor(
				com.unionpay.smartDG.R.color.gary));
	}
	...
	private void displyaLoadingStatus(int completeCode) {
		...
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(com.unionpay.smartDG.R.drawable.offlinearrow_stop);
