package com.unionpay.smartDG.weather;
...
public class WeatherSearchActivity extends Activity implements OnWeatherSearchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.unionpay.smartDG.R.layout.weather_activity);
        init();
        searchliveweather();
    ...
    private void init() {
        TextView city = (TextView) findViewById(com.unionpay.smartDG.R.id.city);
        city.setText(cityname);
        forecasttv = (TextView) findViewById(com.unionpay.smartDG.R.id.forecast);
        reporttime1 = (TextView) findViewById(com.unionpay.smartDG.R.id.reporttime1);
        reporttime2 = (TextView) findViewById(com.unionpay.smartDG.R.id.reporttime2);
        weather = (TextView) findViewById(com.unionpay.smartDG.R.id.weather);
        Temperature = (TextView) findViewById(com.unionpay.smartDG.R.id.temp);
        wind = (TextView) findViewById(com.unionpay.smartDG.R.id.wind);
        humidity = (TextView) findViewById(com.unionpay.smartDG.R.id.humidity);
    }
    ...
    public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
                ...
                ToastUtil.show(WeatherSearchActivity.this, com.unionpay.smartDG.R.string.no_result);
            }
        } else {
