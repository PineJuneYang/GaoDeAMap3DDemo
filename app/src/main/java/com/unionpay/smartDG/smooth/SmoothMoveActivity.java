package com.unionpay.smartDG.smooth;
...
import com.unionpay.smartDG.offlinemap.ToastUtil;
...
public class SmoothMoveActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.unionpay.smartDG.R.layout.activity_smooth_move);
    ...
    public void startMove(View view) {
        ...
        // 设置 平滑移动的 图标
        smoothMarker.setDescriptor(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.icon_car));
    ...
    private View getInfoWindowView(Marker marker) {
        if (infoWindowLayout == null) {
            ...
            infoWindowLayout.setBackgroundResource(com.unionpay.smartDG.R.drawable.infowindow_bg);
    ...
    private void addPolylineInPlayGround() {
        ...
        textureList.add(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.custtexture));
        ...
        mPolyline = mAMap.addPolyline(new PolylineOptions().setCustomTexture(BitmapDescriptorFactory.fromResource(com.unionpay.smartDG.R.drawable.custtexture)) //setCustomTextureList(bitmapDescriptors)
