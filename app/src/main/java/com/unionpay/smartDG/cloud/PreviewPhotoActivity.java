...
public class PreviewPhotoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.preview_photo_activity);
		getIntentData();
		mQueue = Volley.newRequestQueue(this.getApplicationContext());
		mImageLoader = new ImageLoader(mQueue, new AMApCloudImageCache());
		mTitletv = (TextView) findViewById(com.unionpay.smartDG.R.id.title_des_text);
		mTitletv.getPaint().setFakeBoldText(true);
		mpbLoding = (ProgressBar) findViewById(com.unionpay.smartDG.R.id.pb_loading);
		mphtoPager = (ViewPager) findViewById(com.unionpay.smartDG.R.id.viewpager_photo);
		mphtoPager.setOnPageChangeListener(pageChangeListener);
		mButtonback = (Button) findViewById(com.unionpay.smartDG.R.id.back);
