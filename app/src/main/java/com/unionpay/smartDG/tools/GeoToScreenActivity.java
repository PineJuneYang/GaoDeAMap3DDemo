package com.unionpay.smartDG.tools;
...
public class GeoToScreenActivity extends Activity implements OnMapClickListener, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.location2screen_activity);
	...
	private void init() {
		...
		latView = (EditText)findViewById(com.unionpay.smartDG.R.id.pointLat);
		lngView = (EditText)findViewById(com.unionpay.smartDG.R.id.pointLng);
		xView = (EditText)findViewById(com.unionpay.smartDG.R.id.pointX);
		yView = (EditText)findViewById(com.unionpay.smartDG.R.id.pointY);
		lnglat2pointBtn = (Button)findViewById(com.unionpay.smartDG.R.id.lnglat2pointbtn);
		point2LatlngBtn = (Button)findViewById(com.unionpay.smartDG.R.id.point2Latlngbtn);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case com.unionpay.smartDG.R.id.lnglat2pointbtn:
			toScreenLocation();
			break;
		case com.unionpay.smartDG.R.id.point2Latlngbtn:
			toGeoLocation();
			break;
		default:
			break;
