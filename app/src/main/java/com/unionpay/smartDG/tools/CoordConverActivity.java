...
public class CoordConverActivity extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.unionpay.smartDG.R.layout.convert_activity);
		init();
	 ...
	 */
	private void init() {
		selectcoord = (Spinner)findViewById(com.unionpay.smartDG.R.id.coord);
		...
		resultview = (TextView)findViewById(com.unionpay.smartDG.R.id.result);
